...
const SESSION_KEY = 'roles_django_session'
...
export function fetchModule(module) {
  const paths = { People: '/employees/', Departments: '/departments/', Roles: '/roles/', Attendance: '/employees/attention/', Payroll: '/employees/payrolls/' }
  return request(paths[module])
}

export function getAdminUrl() { return import.meta.env.VITE_DJANGO_ADMIN_URL || 'http://127.0.0.1:8000/admin/' }
